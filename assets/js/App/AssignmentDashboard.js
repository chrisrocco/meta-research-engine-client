(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('/App/AssignmentDashboard', ['exports', 'BaseApp'], factory);
        ...
        global.AppAssignmentDashboard = mod.exports;
    }
    ...
    exports.getInstance = exports.run = exports.AssignmentDashboard = undefined;

    var _BaseApp3 = babelHelpers.interopRequireDefault(_BaseApp2);

    var AssignmentDashboard = function (_BaseApp) {
        babelHelpers.inherits(AssignmentDashboard, _BaseApp);

        function AssignmentDashboard() {
            babelHelpers.classCallCheck(this, AssignmentDashboard);
            return babelHelpers.possibleConstructorReturn(this, (AssignmentDashboard.__proto__ || Object.getPrototypeOf(AssignmentDashboard)).apply(this, arguments));
        }

        babelHelpers.createClass(AssignmentDashboard, [{
            key: 'processed',
            value: function processed() {
                babelHelpers.get(AssignmentDashboard.prototype.__proto__ || Object.getPrototypeOf(AssignmentDashboard.prototype), 'processed', this).call(this);
    ...
    function getInstance() {
        if (!instance) {
            instance = new AssignmentDashboard();
        }
        return instance;
    }
    ...
    exports.default = AssignmentDashboard;
    exports.AssignmentDashboard = AssignmentDashboard;
    exports.run = run;
