(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define('/App/Assignments2', ['exports', 'BaseApp'], factory);
    ...
    global.AppAssignments2 = mod.exports;
  }
  ...
  exports.getInstance = exports.run = exports.Assignments2 = undefined;

  var _BaseApp3 = babelHelpers.interopRequireDefault(_BaseApp2);

  var Assignments2 = function (_BaseApp) {
    babelHelpers.inherits(Assignments2, _BaseApp);

    function Assignments2() {
      babelHelpers.classCallCheck(this, Assignments2);
      return babelHelpers.possibleConstructorReturn(this, (Assignments2.__proto__ || Object.getPrototypeOf(Assignments2)).apply(this, arguments));
    }

    babelHelpers.createClass(Assignments2, [{
      key: 'processed',
      value: function processed() {
        babelHelpers.get(Assignments2.prototype.__proto__ || Object.getPrototypeOf(Assignments2.prototype), 'processed', this).call(this);
  ...
  exports.default = Assignments2;
  exports.Assignments2 = Assignments2;
  exports.run = run;
