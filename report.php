...
<head>
    ...
    <title>Paper Report | Big Data UAB</title>
...
<!-- Page -->
<div class="page" ng-app="report" ng-controller="ReportController">
    ...
    <div class="page-content">
        <bd-report masterEncoding="paper.masterEncoding">
            <bd-record record="record" editable="false" ng-repeat="record in paper.masterEncoding"></bd-record>
        </bd-report>
    </div>
</div>
<!-- End Page -->
...
<script src="..\assets/js/Plugin/panel.js"></script>
<script src="../app/report/report.module.js"></script>
<script src="../app/report/report.controller.js"></script>
<script src="../app/report/report.directive.js"></script>
<script src="../app/report/record/record.directive.js"></script>
