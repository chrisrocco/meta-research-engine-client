...
<head>
  ...
  <title>Assignments | Big Data UAB</title>
...
<body class="animsition app-work">
  ...
  <!-- Page -->
  <div class="page full-width" ng-app="assignments" ng-controller="AssignmentsController">
              ...
              <tr ng-repeat="row in tableRows">
                ...
                <td class="work-progress">
                  <div class="progress progress-xs table-content">
                    <div style="width: {[{row.assignment.completion}]}%" class="progress-bar progress-bar-primary progress-bar-indicating"
                ...
                <td class="subject">
                  <button ng-click="loadPaperCoder( row.assignment )" type="button" class="btn btn-animate btn-animate-vertical btn-primary">
                    <span><i class="icon wb-play" aria-hidden="true"></i> Continue
                    </span>
                  </button>
                  <button ng-if="row.paper.status == 'conflicted' && row.assignment.done " ng-click="loadConflictResolution( row.assignment )"
                ...
                <form name="domainForm" autocomplete="off" ng-submit="handleSubmitDomain()">
                  ...
                  <div class="row">
                    <div class="form-group col-md-8">
                      <input ng-model="howManyAssignments" name="min" min="1" max="5" type="number" class="form-control"
  ...
  <script src="..\assets/examples/js/assignments.js"></script>
  <script>
