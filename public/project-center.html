      ...
      <div>
        <div>
          <ul class="site-menu" data-plugin="menu">
            <li class="bdManagerOnly site-menu-item  active open">
                ...
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <div class="btn-group">
                    <div class="dropdown float-left">
                      <button type="button" class="btn btn-icon btn-pure btn-default" title="Setting"><i class="icon wb-edit" aria-hidden="true"></i>
                      </button>
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" ng-click="openProjectBuilder(project)" href="javascript:void(0)">Edit Questions</a>
                        <a class="dropdown-item" ng-click="openForkProject(project)" href="javascript:void(0)">Fork Project</a>
                      </div>
                    </div>
                    <div class="dropdown float-left">
                      <button type="button" class="btn btn-icon btn-pure btn-default" title="Setting"><i class="icon wb-user-add" aria-hidden="true"></i>
                      </button>
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" ng-click="inviteCollaborator(project)" href="javascript:void(0)">Invite Collaborator</a>
                      </div>
                    </div>
                  </div>
                  <button ng-click="openProjectManager(project)" type="button" class="btn btn-outline btn-default project-button">
                    View Project
                  </button>
                </figcaption>
              </figure>
          ...
          <div class="modal-body">
            <form name="createProjectForm" action="" role="form">
              ...
              <div class="form-group">
                ...
                <textarea name="description" id="newDescription" class="form-control mb-sm" placeholder="Project description."
                rows="4"></textarea>
              </div>
            </form>
          </div>
